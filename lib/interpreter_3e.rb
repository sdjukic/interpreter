...
INTEGER, MULTIPLICATION, DIVISION, EOF = 'INTEGER', 'MULTIPLICATION', 'DIVISION', 'EOF'
...
class Token
  ...
  def initialize(type, value)
    # token type: INTEGER, MULTIPLICATION, or EOF
    @type  = type
...
class Interpreter
  ...
  def get_next_token
    ...
    while !@current_char.nil?
      ...
      if @current_char == '*'
        advance
        return Token.new(MULTIPLICATION, '*')
      end

      if @current_char == '/'
        advance
        return Token.new(DIVISION, '/')
      end
